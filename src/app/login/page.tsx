      ...
      <div className="w-full lg:w-1/2 flex items-start lg:items-center justify-center pt-24 pb-12 lg:pt-0 px-8 bg-background relative overflow-y-auto lg:overflow-visible">
        ...
        >
          ...
          <div className="mb-8 text-center lg:text-left">
            <h1 className="font-heading text-3xl md:text-4xl text-foreground mb-2 uppercase tracking-tight leading-tight">Access Your Account</h1>
            <p className="font-body text-sm text-muted-foreground opacity-70 italic tracking-wide">Enter your credentials to continue</p>
          </div>
