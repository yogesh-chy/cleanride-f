      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-secondary overflow-hidden group">
        ...
        <div className="relative z-10 w-full p-16 flex flex-col justify-end">
          ...
          <div className="space-y-6">
            ...
            >
              CREATE <br />
              <span className="text-gradient">NEW ACCESS.</span>
            </motion.h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background relative">
        ...
        >
          ...
          <div className="mb-10 text-center lg:text-left">
            <h1 className="font-heading text-4xl text-foreground mb-2 uppercase tracking-tight leading-tight">Set New Password</h1>
          ...
          <div className="w-full space-y-8">
            ...
            {!message && (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  <label className="font-body text-xs text-muted-foreground uppercase tracking-[0.2em] px-1 font-bold">New Password</label>
                ...
                <div className="space-y-2">
                  <label className="font-body text-xs text-muted-foreground uppercase tracking-[0.2em] px-1 font-bold">Confirm Password</label>
                  <input
                    type="password" 
            ...
            <div className="mt-8 pt-6 border-t border-white/5 text-center">
              <p className="font-body text-sm text-muted-foreground">
                <Link href="/login" className="text-primary font-bold hover:underline transition-all">Back to Login</Link>
              </p>
            </div>
            </div>
          </motion.div>
